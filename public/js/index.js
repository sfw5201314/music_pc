$(function () {
    ...
    async function selectTrack(flag) {
        ...
        musicImgs.find('.img').css({ 'background': 'url(' + currImg + ') center' })
        boxImgs.css({ 'background': 'url(' + currImg + ') center 100%' })
    ...
    async function music() {
        ...
        /*
            ...
            */
        //配置baseURL
        // axios.defaults.baseURL = 'https://api.uomg.com/api/rand.music';
